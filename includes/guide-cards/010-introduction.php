        ...
        <div itemprop="step" itemscope itemtype="https://schema.org/HowToStep">
            ...
            <div itemprop="text">
                ...
                <div class="card sub-card">
                    ...
                    <ul>
                        <li>The Workshop Mod Manager - a Windows app with a built-in workshop browser that downloads and installs collections on its own</li>
                        <li>The BatchFile Generator (website and TamperMonkey script) for creating SteamCMD command files manually</li>
                    </ul>
                    <br>
                    <p>
                    ...
                    <div class="notice-box">
                        <h4>💡 Quick Info</h4>
                        <p>On Windows, the easiest way is the <a href="#mod-manager-details">Workshop Mod Manager</a> - it handles everything from browsing to installation.
                        Prefer doing it yourself, or on Linux? Use the BatchFile Generator to create ready-to-use commands for <a href="#steamcmd-setup">SteamCMD</a> -
                        think of it as your friendly helper that translates Workshop collections into SteamCMD language!</p>
                    </div>
                </div>
                ...
                <div class="card sub-card">
                    ...
                    <ul class="feature-list">
                        <li>The Workshop Mod Manager downloads and installs complete collections automatically</li>
                        <li>The BatchFile Generator creates the correct SteamCMD commands if you prefer the manual way</li>
                        <li>Either way, mod management gets much easier on any platform</li>
                    </ul>

                    <div class="notice-box info">
                        <h4>Getting Started</h4>
                        <p>All you need is a Workshop collection URL - paste it into the Workshop Mod Manager
                        or into the BatchFile Generator, whichever suits you.</p>
                    </div>
                </div>
                ...
                <div class="card sub-card">
                    ...
                    <div class="tools-grid">
                        ...
                        <div class="tool-card">
                            <h4>BatchFile Generator TamperMonkey Script</h4>
                ...
                <div class="card sub-card">
                    ...
                    <div class="requirements">
                        <ul>
                            ...
                            <li>SteamCMD - the Workshop Mod Manager downloads it for you; for the manual way see the <a href="#steamcmd-setup">setup guide</a></li>
                        </ul>
                    </div>
